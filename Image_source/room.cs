public class Room {
    private double[,,] wallVertices = new double[,,]  {{ {0, 0, 0}, {5, 0, 0}, {5, 0, 5}, {0, 0, 5} },    //Write the vertices of each wall of the room.     
                                                    { {5, 0, 0}, {0, 5, 0}, {0, 5, 5}, {0, 0, 5} },    //Write the vertices of each wall of the room.     
