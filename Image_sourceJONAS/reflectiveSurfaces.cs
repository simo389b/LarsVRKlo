...
public class Program {
    public static void Main() {
        ...
        Tuple<double[,],double[,]> firstISMResults = firstImageSource.GetFirstImageSourcesAndProj();
        ...
        SecondImageSources secondImageSource = new SecondImageSources(firstImageSources, normals, wallVertices, point);
